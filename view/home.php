<?php 
$load_data_barang_from_include = true;
...
<div class="container">
    <h1>Data Barang</h1>
    <div class="main">
        <a href="<?= BASE_URL ?>module/user/tambah.php">+ Tambah Barang</a><br><br>
        <table>
            <tr>
                <th>Gambar</th>
                <th>Nama Barang</th>
                ...
                <?php while ($row = mysqli_fetch_array($result)): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= BASE_URL ?>module/user/hapus.php?id=<?= $row['id_barang']; ?>" onclick="return confirm('Yakin hapus?')">Hapus</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            <?php else: ?>
